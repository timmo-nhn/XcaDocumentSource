...
{
    public OperationOutcome Outcome { get; init; } = new();

    // Needed by controller for ATNA logging
    public ProvideAndRegisterDocumentSetRequestType? ProvideAndRegisterRequest { get; init; }
    public SoapEnvelope? RegistryResponse { get; set; }

    public List<RegistryErrorType>? Errors { get; init; }
